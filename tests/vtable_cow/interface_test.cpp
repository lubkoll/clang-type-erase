...
TEST( TestVTableCOWFooable, Empty )
{
    Fooable fooable;
    death_tests(fooable);
...
TEST( TestVTableCOWFooable, CopyFromValue )
{
...
TEST( TestVTableCOWFooable, CopyConstruction )
{
...
TEST( TestVTableCOWFooable, CopyFromValueWithReferenceWrapper )
{
    MockFooable mock_fooable;
...
TEST( TestVTableCOWFooable, MoveFromValue )
{
    MockFooable mock_fooable;
    auto value = mock_fooable.foo();
...
TEST( TestVTableCOWFooable, MoveConstruction )
{
    Fooable fooable = MockFooable();
    auto value = fooable.foo();
...
TEST( TestVTableCOWFooable, MoveFromValueWithReferenceWrapper )
{
    MockFooable mock_fooable;
...
TEST( TestVTableCOWFooable, CopyAssignFromValue )
{
    MockFooable mock_fooable;
    Fooable fooable;
...
TEST( TestVTableCOWFooable, CopyAssignment )
{
    Fooable fooable = MockFooable();
    Fooable other;
    other = fooable;
...
TEST( TestVTableCOWFooable, CopyAssignFromValueWithReferenceWrapper )
{
    MockFooable mock_fooable;
    Fooable fooable;
...
TEST( TestVTableCOWFooable, MoveAssignFromValue )
{
    MockFooable mock_fooable;
    Fooable fooable;
...
TEST( TestVTableCOWFooable, MoveAssignment )
{
    Fooable fooable = MockFooable();
    auto value = fooable.foo();
    Fooable other;
...
TEST( TestVTableCOWFooable, MoveAssignFromValueWithReferenceWrapper )
{
    MockFooable mock_fooable;
    Fooable fooable;
...
TEST( TestVTableCOWFooable, Cast )
{
    Fooable fooable = MockFooable();
...
TEST( TestVTableCOWFooable, ConstCast )
{
