...
using VTableCOW::Fooable;
using Mock::MockFooable;

TEST( TestVTableCOWFooable_HeapAllocations, Empty )
{
...
TEST( TestVTableCOWFooable_HeapAllocations, CopyFromValue )
{
...
TEST( TestVTableCOWFooable_HeapAllocations, CopyConstruction )
{
    auto expected_heap_allocations = 0u;
...
TEST( TestVTableCOWFooable_HeapAllocations, CopyFromValueWithReferenceWrapper )
{
    auto expected_heap_allocations = 1u;
...
TEST( TestVTableCOWFooable_HeapAllocations, MoveFromValue )
{
    auto expected_heap_allocations = 1u;
...
TEST( TestVTableCOWFooable_HeapAllocations, MoveConstruction )
{
    auto expected_heap_allocations = 0u;
...
TEST( TestVTableCOWFooable_HeapAllocations, MoveFromValueWithReferenceWrapper )
{
    auto expected_heap_allocations = 1u;
...
TEST( TestVTableCOWFooable_HeapAllocations, CopyAssignFromValue )
{
    auto expected_heap_allocations = 1u;
...
TEST( TestVTableCOWFooable_HeapAllocations, CopyAssignment )
{
    auto expected_heap_allocations = 0u;
...
TEST( TestVTableCOWFooable_HeapAllocations, CopyAssignFromValuenWithReferenceWrapper )
{
    auto expected_heap_allocations = 1u;
...
TEST( TestVTableCOWFooable_HeapAllocations, MoveAssignFromValue )
{
    auto expected_heap_allocations = 1u;
...
TEST( TestVTableCOWFooable_HeapAllocations, MoveAssignment )
{
    auto expected_heap_allocations = 0u;
...
TEST( TestVTableCOWFooable_HeapAllocations, MoveAssignFromValueWithReferenceWrapper )
{
    auto expected_heap_allocations = 1u;
