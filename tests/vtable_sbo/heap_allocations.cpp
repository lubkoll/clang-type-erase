...
TEST( TestVTableSBOFooable_HeapAllocations, CopyFromValue_SmallObject )
{
    auto expected_heap_allocations = 0u;
...
TEST( TestVTableSBOFooable_HeapAllocations, CopyConstruction_SmallObject )
{
    auto expected_heap_allocations = 0u;
...
TEST( TestVTableSBOFooable_HeapAllocations, CopyAssignFromValue_SmallObject )
{
    auto expected_heap_allocations = 0u;
...
TEST( TestVTableSBOFooable_HeapAllocations, CopyAssignment_SmallObject )
{
    auto expected_heap_allocations = 0u;
...
TEST( TestVTableSBOFooable_HeapAllocations, CopyFromValue_LargeObject )
{
...
TEST( TestVTableSBOFooable_HeapAllocations, CopyConstruction_LargeObject )
{
    auto expected_heap_allocations = 1u;
...
TEST( TestVTableSBOFooable_HeapAllocations, CopyAssignFromValue_LargeObject )
{
    auto expected_heap_allocations = 1u;
...
TEST( TestVTableSBOFooable_HeapAllocations, CopyAssignment_LargeObject )
{
    auto expected_heap_allocations = 1u;
