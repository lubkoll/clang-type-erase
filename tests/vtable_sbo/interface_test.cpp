...
TEST( TestVTableSBOFooable, Empty )
{
    Fooable fooable;
    death_tests(fooable);
...
TEST( TestVTableSBOFooable, CopyFromValue_SmallObject )
{
...
TEST( TestVTableSBOFooable, CopyConstruction_SmallObject )
{
...
TEST( TestVTableSBOFooable, CopyFromValueWithReferenceWrapper_SmallObject )
{
    MockFooable mock_fooable;
...
TEST( TestVTableSBOFooable, CopyFromValueWithReferenceWrapper_LargeObject )
{
    MockLargeFooable mock_fooable;
    Fooable fooable( std::ref(mock_fooable) );
...
TEST( TestVTableSBOFooable, MoveFromValue_LargeObject )
{
    MockLargeFooable mock_fooable;
    auto value = mock_fooable.foo();
    Fooable fooable( std::move(mock_fooable) );
...
TEST( TestVTableSBOFooable, MoveConstruction_SmallObject )
{
    Fooable fooable = MockFooable();
    auto value = fooable.foo();
...
TEST( TestVTableSBOFooable, MoveFromValueWithReferenceWrapper_SmallObject )
{
    MockFooable mock_fooable;
...
TEST( TestVTableSBOFooable, MoveFromValueWithReferenceWrapper_LargeObject )
{
    MockLargeFooable mock_fooable;
    Fooable fooable( std::move(std::ref(mock_fooable)) );
...
TEST( TestVTableSBOFooable, CopyAssignFromValue_LargeObject )
{
    MockLargeFooable mock_fooable;
    Fooable fooable;
...
TEST( TestVTableSBOFooable, CopyAssignment_SmallObject )
{
    Fooable fooable = MockFooable();
    Fooable other;
    other = fooable;
...
TEST( TestVTableSBOFooable, CopyAssignFromValueWithReferenceWrapper_SmallObject )
{
    MockFooable mock_fooable;
    Fooable fooable;
...
TEST( TestVTableSBOFooable, CopyAssignFromValueWithReferenceWrapper_LargeObject )
{
    MockLargeFooable mock_fooable;
    Fooable fooable;
...
TEST( TestVTableSBOFooable, MoveAssignFromValue_SmallObject )
{
    MockFooable mock_fooable;
    Fooable fooable;
...
TEST( TestVTableSBOFooable, MoveAssignment_SmallObject )
{
    Fooable fooable = MockFooable();
    auto value = fooable.foo();
    Fooable other;
...
TEST( TestVTableSBOFooable, MoveAssignFromValueWithReferenceWrapper_SmallObject )
{
    MockFooable mock_fooable;
    Fooable fooable;
...
TEST( TestVTableSBOFooable, MoveAssignFromValueWithReferenceWrapper_LargeObject )
{
    MockLargeFooable mock_fooable;
    Fooable fooable;
...
TEST( TestVTableSBOFooable, Cast_SmallObject )
{
    Fooable fooable = MockFooable();
...
TEST( TestVTableSBOFooable, Cast_LargeObject )
{
    Fooable fooable = MockLargeFooable();
...
TEST( TestVTableSBOFooable, ConstCast_SmallObject )
{
...
TEST( TestVTableSBOFooable, ConstCast_LargeObject )
{
